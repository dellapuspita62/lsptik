    ...
    <main class="flex-shrink-0">
        ...
        <div class="py-5 ">
            ...
            <div class="text-center mb-5">
                <h1 class="fw-bolder">Pendaftaran UjiKom</h1>
            </div>
                    ...
                    <div class="container">
                        <form action="pendaftaran_proses.php" method="POST">
                            ...
                            <tr>
                                ...
                                <input type="text" name="skema" id="skema" class="form-control" placeholder="Skema" required>
                            </tr>
                            <tr>
                            ...
                            <a href="pendaftaran.php" name="batal" class="btn btn-danger"> Batal </a>
                    </div>
                </div>
            </div>
        </div>
